// Reading Serial Bus is functioning as intended, not recognising the commands being input however.
// Not tested output to DALI bus. 
// Dali library should be installed correctly from arduino forum.


/* *** Tom ****
- if you update please leave comments here so I know and I will update on github
:-) thanks Simon.

10-09-24 based on project here 
  https://projecthub.arduino.cc/NabiyevTR/simple-dali-controller-c652b7
  Added some Serial.prints to show that a command has been received
  updated help sub. to show you need no line Ending
...
void help() {
  ...
  Serial.println("Send commands with 'No line ending'");
  Serial.println();
}
...
void loop() {
  ...
  if (comMsg == "initialise" or comMsg == "ini") {
    Serial.println("'initialise' received");
    dali.initialisation();
  } // initialisation
